...
public class MessageHub :Hub
{
    ...
    public MessageHub(IUnitOfWork unitOfWork,
                      IMapper mapper,
                      IHubContext<PresenceHub> presentsHub)
    {
    ...
    public async Task SendMessage(CreateMessageDto createMessageDto)
    {
        ...
        else
        {
            ...
            if (connections != null)
            {
                await _presentsHub.Clients.Clients(connections).SendAsync("NewMessageReceived", new {username = sender.UserName, knownAs = sender.KnownAs});
            }
        }
